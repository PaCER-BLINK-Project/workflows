...
OUTPUT_DIR=$MYSCRATCH/${OBSERVATION_ID}_test_res1s
...
print_run rocgdb --args `which blink_pipeline` -u -c 4 -C -1 -t 1s  -o ${OUTPUT_DIR} -n 1024  -F 30 -M ${METAFITS}  -w N -v 100 -r -L -G -s ${SOL_FILE} -b 0  -r -V 1 -A 13,27,30,55,58,71,72,84,115  ${INPUT_FILES} 
