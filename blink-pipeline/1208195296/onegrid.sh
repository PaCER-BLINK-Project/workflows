...
METAFITS=$ROOT_DIR/1208195296.metafits
SOL_FILE=$ROOT_DIR/1208211232.bin
OUTPUT_DIR=$MYSCRATCH/1208195296/images_1second
mkdir -p $OUTPUT_DIR
...
BLINK_COMMAND_LINE="`which blink_pipeline` -u -c 4 -C -1 -t 1.00s -o ${OUTPUT_DIR} -n 8192  -F 30 -M ${METAFITS}  -w N -v 100 -r -L -G -s ${SOL_FILE} -b 0  -r -V 1 -A5,54,87,91,93,95,99,101,117,123  ${INPUT_FILES}" 
